...
@section('content')
    ...
    <div style="max-width: 600px;" class="w-100 m-auto bg-white p-3 rounded ">
        <h1 class="h3 mt-3 mb-3 text-center text-black">Insert Menu</h1>
        <form  action="/insertMenu" method="post" enctype='multipart/form-data'>
            ...
            <div class="mb-4 row">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="menu_title" id="menu_title"  placeholder="Name">
                </div>
            </div>
            <div class="mb-4 row">
                <label class="col-sm-2 form-label" for="email">Route</label>
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="link" id="link"  placeholder="Route">
                </div>
            </div>
            <div class="mt-3">
